...
#include </eda_work/tolba/gem5/dr_ayman/net/alg1/conv_2d_1.h>
...
#define NUM_FILTERS_1 192
#define NUM_FILTERS_01 384
...
uint8_t    output1[IMAGE_WIDTH-FILTER_SIZE1+1+ 2 * PAD_SIZE][IMAGE_WIDTH-FILTER_SIZE1+1+ 2 * PAD_SIZE][NUM_FILTERS_01];
